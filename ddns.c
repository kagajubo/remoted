...
{
	if(_ddns->ddns_para.provider==DDNS_DYNDNS){
	...
	}else if(_ddns->ddns_para.provider==DDNS_NOIP){
	...
	}else if(_ddns->ddns_para.provider==DDNS_3322){
	...
	}else if(_ddns->ddns_para.provider==DDNS_CHANGEIP){
